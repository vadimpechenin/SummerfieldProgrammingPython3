...
Программа считывает первые 1000 байтов из каждого файла, указанного в командной строке, и для каждого из них выводит его тип

использование
python.exe magic-numbers.py D:\PYTHON\Programms\SummerfieldProgrammingPython3\Chapter8\main\src\structural\dinamic\*.* 
"""
